      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="lg:flex lg:items-center lg:gap-12">
          ...
          <div className="text-center lg:text-left lg:flex-1">
            ...
            {/* Headline */}
            <h1 className="animate-fade-in-up stagger-1 text-3xl sm:text-4xl lg:text-5xl font-extrabold leading-[1.1] tracking-tight mb-4 sm:mb-6">
              Créez votre app web
              <br />
            ...
            {/* Subtitle */}
            <p className="animate-fade-in-up stagger-2 text-base sm:text-lg lg:text-xl text-[var(--muted-foreground)] max-w-2xl mx-auto lg:mx-0 mb-8 sm:mb-10 leading-relaxed px-2 lg:px-0">
            ...
            {/* CTA Buttons */}
            <div className="animate-fade-in-up stagger-3 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start items-center px-2 lg:px-0">
            ...
            {/* Social proof */}
            <div className="animate-fade-in-up stagger-4 mt-8 sm:mt-12 flex flex-col items-center lg:items-start gap-3 sm:gap-6 text-sm text-[var(--muted-foreground)]">
              ...
              <span className="text-xs sm:text-sm text-center lg:text-left">Gratuit pendant 3 jours, puis 5€/mois par app</span>
            </div>
          </div>

          {/* Preview mockup */}
          <div className="animate-fade-in-up stagger-5 mt-10 sm:mt-16 lg:mt-0 lg:flex-1 relative">
            <div className="relative mx-auto max-w-4xl lg:max-w-none rounded-xl sm:rounded-2xl border border-[var(--border)] bg-[var(--card)] shadow-2xl shadow-black/10 overflow-hidden">
              {/* Browser bar */}
